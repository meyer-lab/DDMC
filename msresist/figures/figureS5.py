...
def makeFigure():
    ...
    plotActualVsPredicted(ax[2], PLSRegression(n_components=3), d, y, y_pred="cross-validation", color="grey", type="bar", title="Raw data (3 Components)")
    ...
    plotActualVsPredicted(ax[4], PLSRegression(n_components=4), c_kmeans, y, y_pred="cross-validation", color="darkred", type="bar", title="k-means (4 Components)")
    ...
    plotActualVsPredicted(ax[6], PLSRegression(n_components=2), c_gmm, y, y_pred="cross-validation", color="olive", type="bar", title="GMM (2 Components)")
    ...
    plotActualVsPredicted(ax[8], PLSRegression(n_components=3), centers, y, y_pred="cross-validation", color="orange", type="bar", title="DDMC Sequence (3 Components)")
    ...
    plotActualVsPredicted(ax[10], PLSRegression(n_components=4), centers, y, y_pred="cross-validation", color="darkblue", type="bar", title="DDMC mix (4 Components)")
