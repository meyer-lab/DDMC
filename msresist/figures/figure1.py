...
def makeFigure():
    ...
    hm_af154 = mpimg.imread('resistance-MS/msresist/data/Signaling/CV_reducedHM_AF154.png')
    hm_erl = mpimg.imread('resistance-MS/msresist/data/Signaling/CV_reducedHM_Erl.png')
