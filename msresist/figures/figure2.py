...
def makeFigure():
    ...
    hm_af154 = mpimg.imread('resistance-MS/msresist/data/Signaling/CM_reducedHM_AF154.png')
    hm_erl = mpimg.imread('resistance-MS/msresist/data/Signaling/CM_reducedHM_Erl.png') 
