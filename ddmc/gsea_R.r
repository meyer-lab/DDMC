...
cm <- read.gmt("ddmc/data/cluster_analysis/c6.all.v7.4.entrez.gmt")

data <- read.csv("ddmc/data/cluster_analysis/CPTAC_GSEA_Input.csv")
...
im <- read.gmt("ddmc/data/cluster_analysis/c7.immunesigdb.v7.4.entrez.gmt")
...
imdata <- read.csv("ddmc/data/cluster_analysis/CPTAC_GSEA_ImmuneClusters.csv")
