...
- Error across #clusters (+baseline, imputed average, and also maybe random clusters?) –– DONE
- Error accross different weights (-baseline, +baseline supplemental) –– DONE
- Take patients with ALK fusions, peptides related have missingess.
