...
all: figure3.svg figure1.svg figure2.svg figureM2.svg figureM3.svg figureM4.svg
...
output/%/manuscript.html: venv output/%/manuscript.md figure1.svg figure2.svg figure3.svg figureM2.svg figureM3.svg figureM4.svg
	cp *.svg output/$*/
